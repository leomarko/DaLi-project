...
def get_features(word, prevw=None, nextw=None):
    """
    adds suffixes up to 5 characters long, assuming the root is at least 2 characters
    adds suffixes up to 3 characters long from surrounding words, marked with -prev- and -next-
    the whole word is added as a feature, marked -w- after, and once more for the main word as -WORD-
